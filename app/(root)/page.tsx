    ...
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 mb-0 md:py-10 md:my-14 md:h-fit flex items-center">
        <div className="container flex max-w-[64rem] mx-auto flex-col items-center gap-2 sm:gap-4 text-center -mt-8 md:-mt-20">
          ...
          >
            Developer<span className="text-cyan-500">.</span> I Build
            <span className="text-cyan-500">,</span> Ship <span className="text-cyan-500">and</span>{" "}
            Maintain
          </AnimatedText>
          <div className=" max-w-[42rem] text-center">
            <p className="leading-normal max-w-[80%] mx-auto text-muted-foreground text-sm sm:text-lg sm:text-base">
              I am a developer who creates applications that solves real
              problems and impact people. I carefully craft each line of code.
            </p>
          </div>

          <div className="flex flex mt-4 items-center justify-center  sm:space-x-2 gap-3">
            <Link
              href={siteConfig.links.github}
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="p-3 flex items-center gap-2 rounded-full border hover:bg-muted transition-colors">
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <AnimatedText
            ...
            className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7"
          >
            {pagesConfig.clients.description}
          </AnimatedText>
        </div>
